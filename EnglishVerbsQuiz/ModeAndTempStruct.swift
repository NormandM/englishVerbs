...
struct ModeAndTemp {
    ...
    ["I: am + infinitive + ing", "You, We, They: are + infinitive + ing", "He, She, It: is + infinitive + ing", "Example affirmative: I am walking, He is walking", "Example negative: I'm not walking, He isn't walking", "Example interrogative: Am I walking?, Is he walking?"],
    ...
    ["(You): infinitive", "(We): let's + infinitive", "Example affirmative: (You) walk, let's walk", "Example negative: (You) don't walk, (We) Let's not walk"],
    ...
    let temp: [String] = ["Simple Present", "Simple Past", "Present Perfect Simple", "Past Perfect", "Present Progressive", "Past Progressive", "Past Perfect Progressive", "Future Progressive", "Present Perfect Progressive", "Future Perfect Progressive", "Future", "Future Perfect", "Imperative", "Conditional Simple", "Conditional Progressive", "Conditional Perfect", "Conditional Perfect Progressive"]
    let tempContexte: [String] = ["Simple Present", "Simple Past", "Present Perfect Simple", "Past Perfect", "Present Progressive", "Past Progressive", "Past Perfect Progressive", "Future Progressive", "Present Perfect Progressive", "Future Perfect Progressive", "Future", "Future Perfect", "Imperative"]
