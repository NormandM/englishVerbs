...
struct PieChartSetUp {
    ...
    init(entrieBon: Double, entrieMal: Double, entrieAide: Double, pieChartView: PieChartView){
        ...
        let lengendEntry1 = LegendEntry(label: "Right", form: .default, formSize: .nan, formLineWidth: .leastNonzeroMagnitude, formLineDashPhase: .leastNormalMagnitude, formLineDashLengths: nil, formColor: cBon)
        let lengendEntry2 = LegendEntry(label: "Wrong", form: .default, formSize: .nan, formLineWidth: .leastNormalMagnitude, formLineDashPhase: .leastNormalMagnitude, formLineDashLengths: nil, formColor: cMal)
        let lengendEntry3 = LegendEntry(label: "Right with hint", form: .default, formSize: .nan, formLineWidth: .leastNormalMagnitude, formLineDashPhase: .leastNormalMagnitude, formLineDashLengths: nil, formColor: cAide)
